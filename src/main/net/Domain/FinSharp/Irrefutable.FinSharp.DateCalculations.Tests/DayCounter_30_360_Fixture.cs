...
{
    [TestFixture]
    public class DayCounter_30_360_Fixture
    {
        private DayCounter_30_360 _dayCounter;
        
        [SetUp]
        public void SetUp()
        {
            _dayCounter = new DayCounter_30_360();
        }
        ...
        {
            _dayCounter.ComputeDaysBetweenDates(new DateTime(1999, 06, 1), new DateTime(1999, 10, 31)).Should().Be(150);
        }
